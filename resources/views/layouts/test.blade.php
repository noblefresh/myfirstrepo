...
<head>
  ...
  <link href="admin/css/slick.css" rel="stylesheet">
...
<body class="ms-body ms-aside-left-open ms-primary-theme ms-has-quickbar">
  ...
  <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
    ...
    <div class="logo-sn ms-d-block-lg">
      <a class="pl-0 ml-0 text-center" href="index.html">
        <img src="admin/img/costic/costic-logo-216x62.png" alt="logo">
      </a>
    </div>
  ...
  <main class="body-content">
    ...
    <nav class="navbar ms-navbar">
      ...
      <div class="logo-sn logo-sm ms-d-block-sm">
        <a class="pl-0 ml-0 text-center navbar-brand mr-0" href="index.html"><img src="admin/img/costic/costic-logo-84x41.png" alt="logo"> </a>
      </div>
      <ul class="ms-nav-list ms-inline mb-0" id="ms-nav-options">
            ...
            <li class="ms-scrollable ms-dropdown-list">
              <a class="media p-2" href="#">
                <div class="ms-chat-status ms-status-offline ms-chat-img mr-2 align-self-center">
                  <img src="admin/img/costic/customer-3.jpg" class="ms-img-round" alt="people">
                </div>
              ...
              <a class="media p-2" href="#">
                <div class="ms-chat-status ms-status-online ms-chat-img mr-2 align-self-center">
                  <img src="admin/img/costic/customer-2.jpg" class="ms-img-round" alt="people">
                </div>
              ...
              <a class="media p-2" href="#">
                <div class="ms-chat-status ms-status-offline ms-chat-img mr-2 align-self-center">
                  <img src="admin/img/costic/customer-1.jpg" class="ms-img-round" alt="people">
                </div>
        ...
        <li class="ms-nav-item ms-nav-user dropdown">
          <a href="#" id="userDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <img class="ms-user-img ms-img-round float-right" src="admin/img/costic/customer-6.jpg" alt="people">
          </a>
          ...
          <div class="ms-quickbar-container ms-scrollable">
            ...
            <div class="ms-card ms-qa-card ms-deletable">
              ...
              <div class="ms-card-body">
                ...
                <ul class="ms-note-members clearfix mb-0">
                  <li class="ms-deletable"> <img src="admin/img/people/people-3.jpg" alt="member"> </li>
                  <li class="ms-deletable"> <img src="admin/img/people/people-5.jpg" alt="member"> </li>
                </ul>
              </div>
              <div class="ms-card-footer clearfix">
                    ...
                    <li class="ms-scrollable ms-dropdown-list ms-members-list">
                      <a class="media p-2" href="#">
                        <div class="mr-2 align-self-center">
                          <img src="admin/img/people/people-10.jpg" class="ms-img-round" alt="people">
                        </div>
                      ...
                      <a class="media p-2" href="#">
                        <div class="mr-2 align-self-center">
                          <img src="admin/img/people/people-9.jpg" class="ms-img-round" alt="people">
                        </div>
                        <div class="media-body">
                      ...
                      <a class="media p-2" href="#">
                        <div class="mr-2 align-self-center">
                          <img src="admin/img/people/people-7.jpg" class="ms-img-round" alt="people">
                        </div>
                        <div class="media-body">
            ...
            <div class="ms-card ms-qa-card ms-deletable">
              ...
              <div class="ms-card-body">
                ...
                <ul class="ms-note-members clearfix mb-0">
                  <li class="ms-deletable"> <img src="admin/img/people/people-9.jpg" alt="member"> </li>
                </ul>
              </div>
              <div class="ms-card-footer clearfix">
  ...
  <script src="admin/js/perfect-scrollbar.js">
  </script>
  <script src="admin/js/jquery-ui.min.js">
  </script>
  <!-- Global Required Scripts End -->
  <!-- Page Specific Scripts Start -->

  <script src="admin/js/Chart.bundle.min.js">
  </script>
  <script src="admin/js/widgets.js"> </script>
  <script src="admin/js/clients.js"> </script>
  <script src="admin/js/Chart.Financial.js"> </script>
  <script src="admin/js/d3.v3.min.js">
  </script>
  <script src="admin/js/topojson.v1.min.js">
  </script>
  <script src="admin/js/datatables.min.js">
  </script>
  <script src="admin/js/data-tables.js">
  </script>
  <!-- Page Specific Scripts Finish -->
  <!-- Costic core JavaScript -->
  <script src="admin/js/framework.js"></script>
  <!-- Settings -->
